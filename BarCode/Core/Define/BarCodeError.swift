...
public enum BarCodeError: Error {
    ...
    static var mikReceiptFormatInvalid: BarCodeError    { BarCodeError.formatInvalid("The length must be 33 digits") }
    static var mikReceiptContentFormatInvalid: BarCodeError { BarCodeError.formatInvalid("The length must be 32 digits") }
