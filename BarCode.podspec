#
#  Be sure to run `pod spec lint BarCode.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                            BarCode是一个提供各种barcode相关功能的工具开源库，包括UPC-A、UPC-E、EAN13、EAN8等BarCode提供了一些常用的方法，使用方便
                   DESC

  s.homepage     = "https://github.com/iyongzai/BarCode"
